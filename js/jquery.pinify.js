...
*
* Date: Tuesday Aug 16 2011 12:59:36 -05
        ...
        if (window.external.msIsSiteMode()) {
          ...
          window.onunload = function() {
            ...
            for (key in buttons) {
              ...
              value = buttons[key];
              _results.push(window.external.msSiteModeUpdateThumbBarButton(buttons[key].button, true, false));
            }
            return _results;
          };
          window.onload = function() {
            ...
            for (key in buttons) {
              if (!__hasProp.call(buttons, key)) continue;
              value = buttons[key];
              _results.push(window.external.msSiteModeUpdateThumbBarButtons(buttons[key].button, true, true));
            }
            return _results;
          };
